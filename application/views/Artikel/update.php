			...
			<?php foreach($file as $row):?>
				<div class="col-4">
					<div class="card"">
						...
						<button type="button" class="btn btn-danger btn-sm btn-delete-file"  data-idartikel="<?= $row->id_artikel?>" data-id="<?= $row->id_file?>" data-filename=<?= $row->nama_file?>>Hapus</button>
					</div>
				</div>
			<?php endforeach;?>
		</div>
