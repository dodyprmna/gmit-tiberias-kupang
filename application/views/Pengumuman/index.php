								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
					        				...
					        				<input class="form-control" type="text" name="judul_pengumuman" id="judul_pengumuman" placeholder="Judul Pengumuman" required>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
					        				<label>Isi Pengumuman</label>
					        				<textarea class="form-control" name="isi_pengumuman" id="isi_pengumuman" rows="3" placeholder="Isi Pengumuman"></textarea>
					        			</div>
									</div>
			        			</div>
